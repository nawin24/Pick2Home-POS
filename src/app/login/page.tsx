  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-600 via-emerald-500 to-amber-500 p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Large Shadow Logo Behind Login - FIXED */}
      ...
      <div className="w-full max-w-md relative z-10">
          ...
          <div className="relative w-28 h-28 rounded-full overflow-hidden bg-white/95 shadow-2xl p-2 ring-4 ring-white/50 backdrop-blur-sm">
            {!imageError ? (
              ...
              <div className="w-full h-full flex items-center justify-center bg-emerald-100 rounded-full">
                <span className="text-2xl font-bold text-emerald-700">P2H</span>
              </div>
            )}
          </div>
        ...
        <form onSubmit={submit} className="bg-white/95 backdrop-blur-md rounded-2xl p-6 space-y-4 shadow-2xl border border-white/30">
          ...
          <div>
            ...
            <input 
              className="input pl-10 border-slate-200 focus:border-emerald-400 focus:ring-emerald-400 bg-white/80 w-full px-4 py-2 rounded-lg border" 
              type="email" 
              required 
              value={email} 
          ...
          <div>
            ...
            <div className="relative">
              <input 
                className="input pl-10 pr-10 border-slate-200 focus:border-emerald-400 focus:ring-emerald-400 bg-white/80 w-full px-4 py-2 rounded-lg border" 
          ...
          <button className="btn btn-primary w-full py-2.5 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 border-0 shadow-lg shadow-emerald-200/50 text-white rounded-lg font-medium" disabled={loading}>
            {loading ? (
